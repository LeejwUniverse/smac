        ...
        if game_end_code is not None:
            ...
            if game_end_code == 1 and not self.win_counted:
                ...
                if self.log_more_stats:
                    ...
                    for i in range(self.n_agents):
                        ...
                        info["win_move_in_sight_range_team1_agent_" + str(i)] = self.move_in_sight_range_team1[i]
                        ...
                        info["win_move_in_shoot_range_team1_agent_" + str(i)] = self.move_in_shoot_range_team1[i]
                ...
                if self.log_more_stats:
                    ...
                    for i in range(self.n_agents):
                        ...
                        info["loss_move_in_sight_range_team1_agent_" + str(i)] = self.move_in_sight_range_team1[i]
                        ...
                        info["loss_move_in_shoot_range_team1_agent_" + str(i)] = self.move_in_shoot_range_team1[i]
            ...
            if self.log_more_stats:
                ...
                for i in range(self.n_agents):
                    ...
                    info["draw_move_in_sight_range_team1_agent_" + str(i)] = self.move_in_sight_range_team1[i]
                    ...
                    info["draw_move_in_shoot_range_team1_agent_" + str(i)] = self.move_in_shoot_range_team1[i]
                ...
                for i in range(self.n_enemies):
                    ...
                    info["draw_move_in_sight_range_1_team2_agent_" + str(i)] = self.move_in_sight_range_team2[i]
                    info["draw_move_in_sight_range_2_team2_agent_" + str(i)] = self.move_in_sight_range_team2[i]
                    info["draw_move_in_sight_range_3_team2_agent_" + str(i)] = self.move_in_sight_range_team2[i]
                    ...
                    info["draw_move_in_shoot_range_1_team2_agent_" + str(i)] = self.move_in_shoot_range_team2[i]
                    info["draw_move_in_shoot_range_2_team2_agent_" + str(i)] = self.move_in_shoot_range_team2[i]
                    info["draw_move_in_shoot_range_3_team2_agent_" + str(i)] = self.move_in_shoot_range_team2[i]
